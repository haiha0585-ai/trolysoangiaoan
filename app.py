...
<div class="main-header">
    ...
    <p>Tác giả: Đỗ Hải Hà - Trường Tiểu học Tân Bắc - ĐT: 097 2352 525</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đỗ Hải Hà - Trường Tiểu học Tân Bắc - ĐT: 097 2352 525</div>", unsafe_allow_html=True)
